...
var dests = {
    ...
    styles: 'quickstart/css',
    // scripts: './dist/js',
    images: 'quickstart/images',
    fonts: 'quickstart/fonts',
    maps: 'quickstart/maps'
};
var options = {
    autoprefix: {
...
gulp.task('watch', function () {
    ...
    // .less files
    gulp.watch(paths.watchs.styles, {interval:1000}, ['styles']);
